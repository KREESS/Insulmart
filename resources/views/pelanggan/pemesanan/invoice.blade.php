...
<head>
    ...
    <style>
        ...
        .ttd-area { margin-top: 48px; width: 100%; display: flex; justify-content: flex-end;}
        .ttd-box { text-align: right;}
        .ttd-label { margin-bottom: 44px; font-size: 13px; color: #222;}
        .ttd-img { height: 62px; margin-bottom: 6px;}
        .ttd-nama { font-weight: bold; text-decoration: underline; margin-bottom: 0; font-size: 13px;}
        .ttd-jabatan { font-size: 11px; color: #666;}
