...
<section class="position-relative text-center text-white fade-up" style="
  ...
  background: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.6)),
              url('{{ asset('assets/img/landing_page (4)1.png') }}') center center / cover no-repeat;">   <div class="position-relative h-100 d-flex flex-column justify-content-center align-items-center">
